...
const contactInfo = [
  {
    icon: Mail,
    title: 'Email',
    primary: 'support@neuroscope.com',
    secondary: 'sales@neuroscope.com',
  },
  {
    icon: Phone,
    title: 'Phone',
      ...
      <section className="pt-32 pb-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="body-lg text-muted-foreground max-w-2xl mx-auto">
            Have questions about NeuroScope? Our team is here to help. Reach out to us
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-card border border-border rounded-2xl p-8">
                ...
                <div className="space-y-4">
                  <a
                    href="mailto:support@neuroscope.com"
                    className="flex items-center gap-3 p-3 rounded-lg bg-muted/50 hover:bg-muted transition-colors"
                  >
                    <Mail className="w-5 h-5 text-primary" />
                    <span className="text-foreground">support@neuroscope.com</span>
                  </a>
                  <a
