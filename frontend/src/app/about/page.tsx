      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="body-lg text-muted-foreground max-w-3xl mx-auto">
            NeuroScope combines cutting-edge artificial intelligence with decades of neurological expertise
      ...
      <section className="py-20 px-4 bg-muted/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="heading-lg text-foreground mb-4">Why Choose NeuroScope</h2>
      ...
      <section className="py-20 px-4 bg-primary/5">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="body-md text-muted-foreground mb-8">
            Join hundreds of healthcare providers already using NeuroScope for advanced neurological diagnostics.
          </p>
