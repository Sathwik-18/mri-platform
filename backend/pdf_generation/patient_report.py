...
def build_patient_report(
    ...
    try:
        ...
        pdf.cell(box_width, 6, sanitize_for_pdf(display_text), 0, 0, 'C')
        ...
        if confidence:
            ...
            pdf.set_font('Helvetica', '', 9)
            pdf.set_text_color(*pdf.text_color_normal)
            conf_text = f"The AI model is {confidence*100:.1f}% confident in this finding based on the patterns detected in your brain scan."
